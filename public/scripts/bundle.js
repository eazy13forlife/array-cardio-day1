...
var inventors1500 = inventors.filter(function (inventor) {
...
var yearsLived = inventors.reduce(function (total, inventor) {
...
var links = Array.from(document.querySelectorAll(".mw-category-group li"));
var cityNames = links.map(function (link) {
  return link.textContent;
});

var de = cityNames.filter(function (city) {
...
var sortPeopleAlpha = function sortPeopleAlpha() {
  var alphabeticalArray = people.map(function (person) {
    var reverseSplitArray = person.split(", ").reverse().join(", ");
    return reverseSplitArray;
  });
  return alphabeticalArray.sort(function (a, b) {
    var aItem = a.split(", ")[1];
    var bItem = b.split(", ")[1];
    if (aItem < bItem) {
      return -1;
...
var total = data.reduce(function (totalObject, item) {
  if (!totalObject[item]) {
    totalObject[item] = 1;
    console.log("hi");
  } else {
